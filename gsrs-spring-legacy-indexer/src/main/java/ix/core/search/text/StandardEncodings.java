...
public class StandardEncodings {
   ...
   StandardEncodings() {
      encodings.add(new StandardEncoding(TextIndexer.LEVO_REGEX, TextIndexer.LEVO_WORD));
      encodings.add(new StandardEncoding(TextIndexer.DEXTRO_REGEX, TextIndexer.DEXTRO_WORD));
      encodings.add(new StandardEncoding(TextIndexer.RACEMIC_REGEX, TextIndexer.RACEMIC_WORD));
      encodings.add(new StandardEncoding(TextIndexer.RACEMIC_REGEX, TextIndexer.RACEMIC_WORD));
