...
public class GinasProcessingMessage implements ValidationMessage {
	...
	public static GinasProcessingMessage ERROR_MESSAGE_WITH_ID(String msgId, String msg, Object... args){
		msg = String.format(msg, args);
		return new GinasProcessingMessage(MESSAGE_TYPE.ERROR,msg,msgId);
	}
	...
	public static GinasProcessingMessage WARNING_MESSAGE_WITH_ID(String msgId, String msg, Object... args){
		msg = String.format(msg, args);
		return new GinasProcessingMessage(MESSAGE_TYPE.WARNING,msg,msgId);
	}
	...
	public static GinasProcessingMessage NOTICE_MESSAGE_WITH_ID(String msgId, String msg, Object... args){
		msg = String.format(msg, args);
		return new GinasProcessingMessage(MESSAGE_TYPE.NOTICE,msg,msgId);
	}
	...
	public static GinasProcessingMessage INFO_MESSAGE_WITH_ID(String msgId, String msg, Object... args){
		msg = String.format(msg, args);
		return new GinasProcessingMessage(MESSAGE_TYPE.INFO,msg,msgId);
	}
	...
	public static GinasProcessingMessage SUCCESS_MESSAGE_WITH_ID(String msgId, String msg, Object... args){
		msg = String.format(msg, args);
		return new GinasProcessingMessage(MESSAGE_TYPE.SUCCESS,msg,msgId);
	}
