 ...
 * </pre>
 *
 * This class is for Junit 5+ only, if you need Junit 4 support use {@link gsrs.junit.vintage.TimeTravellerRule} instead.
 * <p/>
 * Time Travelling is not threadSafe.
 *
 * Created by katzelda on 3/24/16.
 * @see gsrs.junit.vintage.TimeTravellerRule
 */
