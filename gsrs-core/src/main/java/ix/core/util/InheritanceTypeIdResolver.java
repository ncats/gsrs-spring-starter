...
public class InheritanceTypeIdResolver implements TypeIdResolver {
    ...
    @Autowired
    private JsonTypeIdResolverConfiguration jsonTypeIdResolverConfiguration;

    private synchronized void initIfNeeded(){
        if(jsonTypeIdResolverConfiguration==null){
    ...
    public void init(JavaType javaType) {
        ...
        List<String> packages = jsonTypeIdResolverConfiguration.getTypeIdResolvers();
        if(packages ==null){
