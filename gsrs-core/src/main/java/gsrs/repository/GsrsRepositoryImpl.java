...
@Transactional
public class GsrsRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID>
        implements GsrsRepository<T, ID> {

    private final EntityManager entityManager;

    public GsrsRepositoryImpl(Class<T> domainClass, EntityManager entityManager) {
        super(domainClass, entityManager);
        this.entityManager = entityManager;
    }

    public GsrsRepositoryImpl(
