package gov.hhs.gsrs.applications;
...
@EnableJpaRepositories(
        entityManagerFactoryRef = ApplicationsDataSourceConfig.NAME_ENTITY_MANAGER,
        transactionManagerRef = ApplicationsDataSourceConfig.NAME_TRANSACTION_MANAGER,
        basePackages = {"gov.hhs.gsrs.applications"}
)
@Slf4j
public class ApplicationsDataSourceConfig {
    ...
    protected static final String[] BASE_PACKAGES = {"gov.hhs.gsrs.applications"};
    protected static final String PERSIST_UNIT = "applications";
